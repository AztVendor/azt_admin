    ...
    <div className="bg-gray-50 min-h-screen flex items-center justify-center p-4">
      ...
      <main className="w-full max-w-md md:max-w-6xl bg-white rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row min-h-[700px]">
        ...
        <section
          ...
          data-purpose="register-form-container"
        >
          {/* Logo and Header */}
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm">
              Please provide your details to register your admin profile.
            </p>
          </div>

          {/* Social Login */}
          <button
            className="w-full flex items-center justify-center gap-3 border border-gray-300 rounded-lg py-2.5 px-4 hover:bg-gray-50 transition-colors mb-6 cursor-pointer"
          ...
          <form action="#" className="space-y-4" method="POST">
            ...
            {/* Register Button */}
            <Link href="/admin/dashboard" className="w-full bg-stark-primary text-white py-3 px-4 rounded-lg font-semibold flex items-center justify-between hover:bg-stark-dark transition-colors group mt-6">
              <span>Register</span>
              <svg
